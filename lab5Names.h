...
#define GPIO_PORT_F_PCTL  (*((unsigned long *)0x4002552C))
...
#define GPIO_PORT_F_AFSEL (*((unsigned long *)0x40025420))
...
// TODO configure in 2 pwm in concatinated mode
GPTMCFG_TIMER2 |= 0x00000004;

GPTMTAMR_TIMER2 |= (1u << 3);
GPTMTAMR_TIMER2 &= ~(1u << 2);
GPTMTAMR_TIMER2 |= 0x2;
GPTMCTL_TIMER2 |= (1u << 14);
